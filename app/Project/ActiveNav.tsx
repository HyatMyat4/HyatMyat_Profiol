...
function ActiveNav() {
  ...
  return (
    <div className=" w-full h-[70px] flex flex-row items-center text-gray-200  select-none justify-around">
      ...
      <div
        ...
        } hover:text-sky-500 cursor-pointer text-[13px] 600:text-[15px] flex flex-col items-center `}
      >
        All
      </div>
      <div
        ...
        } hover:text-sky-500 cursor-pointer text-[13px] ml-[10px] 600:text-[15px]`}
      >
        Next js 13
      </div>
      <div
